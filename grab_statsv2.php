...
function grabStats($id, $server)
{
    ...
    switch ($server) {
        case 0:
            ...
            break;
        case 1:
            $url = "http://tagpro-pi.koalabeast.com/profile/" . $profile;
            break;
        case 2:
            $url = "http://tagpro-radius.koalabeast.com/profile/" . $profile;
            break;
        case 3:
            $url = "http://tagpro-chord.koalabeast.com/profile/" . $profile;
            break;
        case 4:
            $url = "http://tagpro-diameter.koalabeast.com/profile/" . $profile;
            break;
        case 5:
            $url = "http://tagpro-centra.koalabeast.com/profile/" . $profile;
            break;
        default:
            $url = "http://tagpro-origin.koalabeast.com/profile/" . $profile;
            $server = 0;
